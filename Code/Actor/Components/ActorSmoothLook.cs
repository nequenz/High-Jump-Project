...
public class ActorSmoothLook : MonoBehaviour
{
    ...
    private Quaternion _absoluteTargetRotation = Quaternion.identity;  
    ...
    public Quaternion AbsoluteRotation => _absoluteTargetRotation;
    public Quaternion ResultRotation => _resultRotation;
    ...
    public void SetLookTarget(Vector3 direction)
    {
        ...
        {
            _targetRotation = _absoluteTargetRotation * Quaternion.LookRotation(direction);
            _isRotation = true;
        }
    }
